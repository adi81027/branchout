...
function initFormData( ) {
  ...
  rblFormArray[ IDFORM ].init( "frm1", "Form Configuration", "#", "POST", "", "") ;
...
function loadForm( elt, file ) {
  ...
  rblFormArray[ IDFORM ].init( jQuery(elt).attr('name'), jQuery(elt).attr('label'),
      jQuery(elt).attr('action'), jQuery(elt).attr('method'), "", jQuery(elt).attr('class')) ;
