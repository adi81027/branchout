...
function rbl_elt( _id, _type ) { 
  ...
  this.drawAfterElt = function(isHt) {
    ...
    if (this.e_help_text && this.e_help_text.length > 0 && this.e_type != "wizard"
          && this.e_type != "label" && this.e_type != "image" && this.e_type != "button") {
      str = "<img class='imghelp'  src='/media/assets/img/eforms/rbl/help-browser.png' border='0' " +
          "title='" + this.e_help_text.replace(reg,"`") +"' alt='" +
          this.e_help_text.replace(reg,"`")+ "' width='16' height='16' hspace='10'>" ;
    }
  ...
  this.drawLabel = function(isHt) { 
    ...
    if (isHt == false) {
      str += "<img src='/media/assets/img/eforms/arrow.png' alt='move' width='16' height='16' class='handle' />"  ;
    }
    ...
    if ( this.e_required == true ) {
      str += "<img class='imgstar' src='/media/assets/img/eforms/rbl/star.png' border='0' alt='obligatoire' title='obligatoire' hspace='0'>" ;
    }else{
      str += "<img class='imgstar' src='/media/assets/img/eforms/rbl/star_transparent.png' border='0' hspace='0'>" ;
    }
    str += "</label>" ;
    if (isHt) str += "\r\n  " ;
...
function changeInput( _no ) {
  ...
  if (typeToAdd == 'date') {
    jQuery("#f_" + _no).find("input").datepicker({
                  showOn: 'button',
                  buttonImage: '/media/assets/img/eforms/rbl/_cal.gif',
...
//	switch (typeToAdd) {
//		case 'Menu':
//			eltToAdd = "<select ><option value='sss'>define</option></select>" ;
//			break ;
//		case 'Button':
//			eltToAdd = "<input type=button size=15 value='define'>" ;
//			break ;
//		default:
//			eltToAdd = "<input type=text size=15 value='define'>" ;
//			break;
//	}


  jQuery(dest).parent( ).append("<li id='f_" + _id +"' class='elt'>" +
    "<img src='/media/assets/img/eforms/arrow.png' alt='move' " +
        "width='16' height='16' class='handle' />" + eltToAdd ) ;
...
function loadElement( elt, ncol, nbel) {
  ...
  jQuery('#sortable' + ncol).append("<li id='f_" + _id +"' class='elt'>" +
               "<img src='/media/assets/img/eforms/arrow.png' alt='move' width='16' height='16' class='handle' />" ) ;
